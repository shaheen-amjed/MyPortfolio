...
export default function About() {
  ...
  return (
    <div className="flex main justify-center items-start gap-4 px-4 flex-wrap">
      {/* Left Side */}
      <div className="flex leftSide flex-col gap-4 w-[600px]">
        ...
        />
        <div className="bg-white/10  backdrop-blur-md rounded-2xl p-6 shadow-lg border-2 border-black">
